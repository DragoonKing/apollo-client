...
export default function DoctorsPage() {
      ...
      <div className="bg-white border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex items-center space-x-2 text-sm">
            <Link href="/" className="text-neutral-500 hover:text-blue-600">Home</Link>
            <ChevronRight className="h-4 w-4 text-neutral-400" />
            <Link href="/doctors" className="text-neutral-500 hover:text-blue-600">Doctors</Link>
            <ChevronRight className="h-4 w-4 text-neutral-400" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-xl opacity-90 mb-6">
              Find experienced doctors for comprehensive healthcare and internal medicine consultation
            </p>
  ...
  onValueChange={(value: "relevance" | "experience" | "rating" | "name") =>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-neutral-400">
                ...
                <li><Link href="#" className="hover:text-white">Specialties</Link></li>
